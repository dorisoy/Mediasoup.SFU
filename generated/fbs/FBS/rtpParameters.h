...
inline const RtpHeaderExtensionUri (&EnumValuesRtpHeaderExtensionUri())[11] {
  static const RtpHeaderExtensionUri values[] = {
    ...
    RtpHeaderExtensionUri::AudioLevel,
...
inline const char *EnumNameRtpHeaderExtensionUri(RtpHeaderExtensionUri e) {
  if (::flatbuffers::IsOutRange(e, RtpHeaderExtensionUri::Mid, RtpHeaderExtensionUri::AbsCaptureTime)) return "";
  const size_t index = static_cast<size_t>(e);
